import { blockchain_workshop_backend } from "../../declarations/blockchain_workshop_backend";
...
window.addEventListener("DOMContentLoaded", async () => {
  try {
    const getAll = await blockchain_workshop_backend.getAllTodo();
...
async function deleteTodo(userId) {
  try {
    ...
    await blockchain_workshop_backend.deleteTodo(userId);
